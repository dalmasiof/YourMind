...
<html>
    <head>
         <title> Your mind - Editar Livro</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="mb-3 row">
         ...
         <div class="btn-group" role="group" aria-label="Basic example" style="width: 250px;">
            <button type="button" class="btn btn-primary" style="border-color:#286BA6; background-color: #286BA6;"> <a class="text-decoration-none" style = "color: white; " href="index.jsp">Cadastrar</a></button>
            <button type="button" class="btn btn-primary" style="border-color:#286BA6; background-color: #286BA6;"> <a class="text-decoration-none" style = "color: white; " href="index.jsp">Cancelar</a></button>
         </div>
