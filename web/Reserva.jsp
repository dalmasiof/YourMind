...
<html>
   ...
   <input type="text" class="form-control" style="width: 250px;"> 
        ...
        <div class="mb-3 row">
      <label for="inputPassword" class="col-sm-2 col-form-label">Data Emprestimo: </label>
      <div class="col-sm-10">
...
<input class="btn btn-primary" type="submit" value="Reservar" style="background-color: #286BA6; ">
